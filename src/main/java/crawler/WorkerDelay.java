...
public class WorkerDelay extends AbstractWorker {

	private static final Logger LOG = LoggerFactory.getLogger(WorkerDelay.class);
//
...
//			new PriorityQueue<>(Comparator.comparing(HostHolder::getNextRequestTime));
	...
	public WorkerDelay(String name) {
		super(name, false);
	}
...
//
//		}
		System.out.println("worker delay");
		pollTask();
	}
